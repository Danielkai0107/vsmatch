...
const EditTournamentPage = lazy(() => import('./pages/EditTournamentPage').then(m => ({ default: m.EditTournamentPage })));
const ManageTournamentPage = lazy(() => import('./pages/ManageTournamentPage').then(m => ({ default: m.ManageTournamentPage })));
const ScorerAuthPage = lazy(() => import('./pages/ScorerAuthPage').then(m => ({ default: m.ScorerAuthPage })));
const JoinPage = lazy(() => import('./pages/JoinPage').then(m => ({ default: m.JoinPage })));
const ScorePage = lazy(() => import('./pages/ScorePage').then(m => ({ default: m.ScorePage })));
const MatchViewPage = lazy(() => import('./pages/MatchViewPage').then(m => ({ default: m.MatchViewPage })));
